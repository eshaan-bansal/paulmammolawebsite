  ...
  return (
    <div className="m-0 p-0" style={{ backgroundColor: "#0A0A0A" }}>
      ...
      <section className="m-0 p-0" style={{ backgroundColor: "#0A0A0A" }}>
        <div className="max-w-4xl mx-auto px-6 py-10 flex flex-col items-center md:items-start text-center md:text-left">
          {/* md:pl offset (photo 220px + gap-8 32px) aligns Paul's info under Chau's text column above */}
          <div className="flex flex-col justify-center md:pl-[252px]">
